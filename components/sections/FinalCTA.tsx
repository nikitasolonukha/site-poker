...
export default function FinalCTA() {
  return (
    <section className="relative bg-[#7D0B29] py-32 md:py-48 overflow-hidden text-[#F1EFE9]">
      ...
      <div className="final-cta-chip absolute left-1/2 -translate-x-1/2 md:left-auto md:translate-x-0 md:right-[15%] bottom-[-20vw] md:bottom-[-250px] w-[80vw] md:w-[600px] aspect-square pointer-events-none z-20">
        <Image
          src="/magnum-chip.svg"
          alt=""
          fill
